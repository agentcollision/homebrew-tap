...
class Agentcollision < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://releases.agentcollision.com/v0.61.10/agentcollision_0.61.10_darwin_amd64.tar.gz"
      sha256 "57410ad0a92c5ab0f6398eda3fdf9519fba172ad0ad1e5ef6af70c42130663e0"
    ...
    if Hardware::CPU.arm?
      url "https://releases.agentcollision.com/v0.61.10/agentcollision_0.61.10_darwin_arm64.tar.gz"
      sha256 "002a558db5eaa23385b817fb64ff7d105219ecc245084293f592a912ac7a4eec"
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://releases.agentcollision.com/v0.61.10/agentcollision_0.61.10_linux_amd64.tar.gz"
      sha256 "799b9b6191781eb9ab1e34e77f12712f3f5a19ff8bc5c97dff6e5d6d944a9a57"
      define_method(:install) do
        bin.install "agentcollision"
        bin.install_symlink "agentcollision" => "agc"
      end
    ...
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://releases.agentcollision.com/v0.61.10/agentcollision_0.61.10_linux_arm64.tar.gz"
      sha256 "426e6508e06ca9f38894fd772a2a6b7c56cb22ba0296918a9aa764707477a84f"
      define_method(:install) do
        bin.install "agentcollision"
        bin.install_symlink "agentcollision" => "agc"
      end
